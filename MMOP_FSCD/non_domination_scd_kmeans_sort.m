...
%        end
        ...
        for i = 1 : length(F(front).f)
            ...
            elseif crowd_dist_obj(i)>avg_crowd_dist_obj && crowd_dist_var(i)<avg_crowd_dist_var

                temp = avg_crowd_dist_var - crowd_dist_var(i);
                special_crowd_dist(i)=max((crowd_dist_obj(i) - temp),avg_crowd_dist_obj); 

            elseif crowd_dist_obj(i)<avg_crowd_dist_obj && crowd_dist_var(i) > avg_crowd_dist_var

                temp = avg_crowd_dist_obj - crowd_dist_obj(i);
                special_crowd_dist(i)=max((crowd_dist_var(i) - temp),avg_crowd_dist_var); 
            else
                % Eq. (7) in the paper
